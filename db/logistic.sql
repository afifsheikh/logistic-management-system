...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2020 at 12:29 PM
...
(41, 80, 76, 2, 15, 34, 34, 1, 'iPhone 11 Pro Max', 'OxMNxQUuD8lrpRMAULsVo6NmG1', 'Block 9, Block N North Nazimabad Town, Karachi,', ' Inc 410 Terry Ave N Seattle, WA', '');
...
INSERT INTO `tbl_encrypt` (`id`, `hash_val`) VALUES
(2, '12VC30REtMjJw'),
(3, '12VC30REtMjJw'),
(4, '11y5TbXqNKJ5o'),
(5, '11y5TbXqNKJ5o'),
...
(14, '11y5TbXqNKJ5o'),
(15, '11y5TbXqNKJ5o'),
(16, '41e42a8f26cb9de61d770e7166def80417860604'),
(17, 'af89eeadc986c91c6b5cdf420d1aee2060afdf5d'),
(18, '233d2373a9b549107936c909e12ddb71c4ba7757'),
(19, '64598e09b53295ed5b67ce81e65c1652ad833b99'),
(20, '50d82b879e57304909514ab2c01593d5d4af48dd'),
(21, '04d4b8e90a25d0efe93018b62fd6fa9ff67f50a6'),
(22, 'f5c3b4ab47d0f4aa5444377c35414f5d57f15853');
...
INSERT INTO `user` (`u_id`, `userName`, `pass`, `role`, `cnic`, `address`, `contactNo`) VALUES
...
(68, 'fifaa', 'yUyWDqJrUkDSYMPJa9UblFlqTu', 'receiver', '4210123456701', 'fifa house at 12', '3345676567'),
...
(74, 'fahad', '7MwW8MDXPPZx55jEtoXQK96lbf', 'sender', '4210123456791', 'house 2 street 5 block 6 nazimabad', '3345566789'),
(75, 'mujtaba', '1PbFpMU8g8H6BlWR4Qou8nxK8n', 'sender', '42101234543231', '2580 Clark Lindenhurst NY ', '3354567876'),
(76, 'ali', 'OxMNxQUuD8lrpRMAULsVo6NmG1', 'receiver', '4210146567554', ' Inc 410 Terry Ave N Seattle, WA', '3356454567'),
(77, 'faisal', 'GN8yiTGErr04aaMEddzCvHSncJ', 'sender', '4210145655677', 'Park Way. Cupertino, CA 95014. United States', '3123456789'),
(78, 'bilal', 'IeMhQKMYlwKE3Wzxi0g48vnSMc', 'sender', '4210133456766', 'house# r-345 bufferzone, NK', '3115675849'),
(79, 'arshad', 'oYuoFHsudDCIu5en7csj2ZvIuo', 'sender', '4210143547658', 'Shahrah-Sher Shah Suri Service Rd N, Shadman Town ', '3345675456'),
(80, 'afzal', 'n0tYVT3bHTp9cY0llzXAnlDEtS', 'sender', '4210134445678', 'Block 9, Block N North Nazimabad Town, Karachi,', '3224564534');
...
--
ALTER TABLE `p_status`
  MODIFY `s_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `user`
  MODIFY `u_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

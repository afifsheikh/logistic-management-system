...
<?php 
	...
	if ($datarow->num_rows > 0) {
		...
		// $testCoin = new BlockChain();
		// $testCoin->push(new Block(1, strtotime("now"), $hash_val));

		// $testCoin->push(new Block(2, strtotime("now"), $hash_val));
		// echo "Chain valid: ".($testCoin->isValid() ? "true" : "false")."\n";

		// $testCoin->chain[1]->data = "441ec45e6d15f0383c3ab249243aeb35d192be2d";
